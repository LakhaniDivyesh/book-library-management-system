...
import { getCountryCode, userSignup } from '../../services/home.service';
...
function Signup() {
    ...
    const onSubmit = (value) => {
        let data = { name: value.name, username: value.username, email: value.email,country_code : value.country_code, mobile: value.mobile, password: value.password };
                ...
                <div className="row m-0 row-con">
                    ...
                    <form id="login-form" className="" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="col-md-12 mb-3">
                            ...
                            />
                            {errors.username && <p className="error"><MdErrorOutline size={16} className='icon' />{errors.username.message}</p>}
                        </div>
                        ...
                        <div className="col-md-12 mb-3">
                            <div className='d-flex align-items-center justify-content-between'>
                                <select className='form-control  px-4 py-2'
                                ...
                                <input
                                    ...
                                    style={{ background: errors.mobile ? 'rgba(228, 26, 26, 0.196)' : 'white', width: "78%" }}
                                />
                            </div>

                            {errors.mobile && <p className="error"><MdErrorOutline size={16} className='icon' />{errors.mobile.message}</p>}
                        </div>
